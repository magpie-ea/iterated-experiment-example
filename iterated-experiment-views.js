            ...
            render: function (CT, babe) {
                const viewTemplate = `
                    <div class="babe-view">
                        <h1 class="babe-view-title">${this.title}</h1>
                        <section class="babe-text-container">
                            <p id="lobby-text" class="babe-view-text">${this.text}</p>
                        </section>
                    </div>
                `;
                ...
                if (babe.generation == 1) {
                    ...
                    babe.lobbyChannel = babe.socket.channel(
                        `iterated_lobby:${babe.deploy.experimentID}:${
                            babe.chain
                        }:${babe.variant}:${babe.generation - 1}:${
                            babe.player
                        }`,
                        { participant_id: babe.participant_id }
                    );
                    ...
                    babe.lobbyChannel
                        ...
                        .receive('ok', (msg) => {
                            document.getElementById(
                                ...
                                <p class="babe-view-text">Assignment tuple: &lt;chain: ${babe.chain}, variant: ${babe.variant},  generation: ${babe.generation}, player: ${babe.player}&gt;</p>
                                `;
                        })
                        .receive('error', (reasons) => {
                            babe.onSocketError(reasons);
